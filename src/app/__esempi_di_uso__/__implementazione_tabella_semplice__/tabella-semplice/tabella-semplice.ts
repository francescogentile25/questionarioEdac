...
@Component({
  ...
  templateUrl: './tabella-semplice.html',
  styleUrl: './tabella-semplice.scss',
})
export class TabellaSemplice {
  // Configurazione completa di esempio
  tableConfig: TableConfigModel<EntityResponse> = {
    id: 'tableConfig_01',

    tableTitle: 'Titolo Esempio Tabella Semplice',
    tableSubtitle: 'Sottotitolo Esempio Tabella Semplice',
