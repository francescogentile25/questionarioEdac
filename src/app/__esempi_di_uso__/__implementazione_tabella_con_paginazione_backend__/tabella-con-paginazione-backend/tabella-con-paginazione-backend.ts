...
import { PageOptionsModel, SortOrderEnum } from "../../../core/models/page-options.model";
...
@Component({
  selector: 'app-tabella-con-paginazione-backend',
  imports: [
    SharedTable
  ],
  templateUrl: './tabella-con-paginazione-backend.html',
  styleUrl: './tabella-con-paginazione-backend.scss',
})
export class TabellaConPaginazioneBackend {
  /** Stato corrente della paginazione lato "backend" (simulato) */
  // pageOptions: PageOptionsModel<EntityResponse> = {
  //   currentPage: 1,
  //   pageSize: 5,
  //   totalResults: MOCK_ARRAY_ENTITA.length,
  //   results: [],
  //   search: undefined,
  //   sortField: undefined,
  ...
  tableConfig: TableConfigModel<EntityResponse> = {
    ...
    tableTitle: 'Titolo Esempio Tabella Con Paginazione Backend',
    tableSubtitle: 'Sottotitolo Esempio Tabella Con Paginazione Backend',
